...
const STRINGS = {
  fr: {
    ...
    emptyHint:
      'Peuples, langues, recettes, contes, proverbes, rites et coutumes apparaitront ici.',
  ...
  en: {
    ...
    emptyHint: 'Peoples, languages, recipes, tales, proverbs, rites and customs will appear here.',
