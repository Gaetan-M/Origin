...
const STRINGS = {
  fr: {
    ...
    deleteLive: 'Supprimer',
    deleteLiveConfirm: 'Supprimer ce direct ? Cette action est définitive.',
    deleteLiveDone: 'Direct supprimé',
    deleteLiveFailed: 'Suppression impossible. Réessayez.',
    live: 'EN DIRECT',
    hostedBy: 'Animé par',
    ...
    inviteShareMessage: 'Rejoignez mon direct sur Origin :',
    inviteGenerating: 'Génération du lien…',
    inviteGenerateLink: 'Générer le lien de partage',
  ...
  en: {
    ...
    deleteLive: 'Delete',
    deleteLiveConfirm: 'Delete this live? This cannot be undone.',
    deleteLiveDone: 'Live deleted',
    deleteLiveFailed: 'Could not delete. Try again.',
    live: 'LIVE',
    hostedBy: 'Hosted by',
    ...
    inviteShare: 'Share',
    inviteWhatsapp: 'WhatsApp',
    inviteShareMessage: 'Join my live on Origin:',
    inviteGenerating: 'Generating link…',
    inviteGenerateLink: 'Generate share link',
